...
namespace OpenAPI.Schema
{
    ...
    public class Operation
    {
        ...
        public ICollection<IOperationParameter> Parameters { get; set; }

        /// <summary>Required. The list of possible responses as they are returned from executing this operation.</summary>
        public IDictionary<HttpStatusCode?, IResponseObject> Responses { get; } = new Dictionary<HttpStatusCode?, IResponseObject>();
