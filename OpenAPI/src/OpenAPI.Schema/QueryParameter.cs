...
namespace OpenAPI.Schema
{
    ...
    public class QueryParameter : Parameter, INotBodyParameter
    {
        public QueryParameter(string name, ParameterType type, ItemsObject items)
            : base(name, ParameterLocation.Query)
        {
            this.Type = type;
            this.Items = items;
        }
